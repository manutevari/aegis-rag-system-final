...
with st.sidebar:
    ...
    grade_override = st.text_input(
        "Employee grade (optional)",
        placeholder="e.g. L4, VP"
    )
        ...
        with st.chat_message("assistant"):
            with st.spinner("🔍 Searching policies…"):
                ...
                if cached_bytes:
                    ...
                    # ✅ FIXED ASYNC BLOCK (Properly indented)
...
with col_trace:
    ...
    if not st.session_state.traces:
        ...
        ICONS = {
            ...
            "context_assembler": "📋", "token_check": "⚖️",
            "summarize_context": "📝", "generate": "✨", "verify": "✅",
        ...
        for step in latest.get("steps", []):
            ...
            with st.expander(f"{ICONS.get(node,'⚙️')} {node}", expanded=False):
